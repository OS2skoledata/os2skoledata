...
/**
 * &lt;p&gt;Java class for uniLoginExportFullMyndighed complex type&lt;/p&gt;.
 * 
 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{https://brugerdatabasen.stil.dk/bpi/wsieksport/7/fullmyndighed}uniLoginExportFullMyndighedBase"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Institution" type="{https://brugerdatabasen.stil.dk/bpi/wsieksport/7/fullmyndighed}institutionFullMyndighed"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
