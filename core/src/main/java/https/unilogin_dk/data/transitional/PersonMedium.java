 ...
 *         &lt;element ref="{https://unilogin.dk/data/transitional}EmailAddress" minOccurs="0"/&gt;
    ...
    extends PersonMini
{
    ...
    @XmlElement(name = "BirthDate", namespace = "https://unilogin.dk/data")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar birthDate;
    @XmlElement(name = "Gender", namespace = "https://unilogin.dk/data")
    @XmlSchemaType(name = "string")
    protected Gender gender;
    @XmlElement(name = "PhotoId", namespace = "https://unilogin.dk/data")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
