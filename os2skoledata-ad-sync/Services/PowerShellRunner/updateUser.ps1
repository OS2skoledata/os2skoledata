function Invoke-Method {
	param(
		...
		[string] $OldDN = $(throw "Please specify an OldDN."),
		[string] $NewDN = $(throw "Please specify a NewDN.")#,
	...
	$result = "Updating " + $SAMAccountName + ", " + $Name + ", " + $UserRole + ", " + $DomainController + ", " + $OldDN + ", " + $NewDN
